                    ...
                    <div className="flex justify-between items-center mb-4">
                        ...
                        {isEditingDesc ? (
                            <div className="space-x-2">
                                ...
                                <button
                                    onClick={() => {
                                        setFormDesc(commit.description)
                                        setIsEditingDesc(false)
                                    }}
                            ...
                            {commit.comments.length === 0 ? (
                                ...
                                <div className="border-2 border-gray-700 rounded-lg overflow-y-auto max-h-[30vh] p-4 space-y-4">
                                    {commit.comments.map(c => (
                                        <div
                                            key={c._id}
                                            className="bg-gray-900 shadow rounded-lg p-4 border-2 border-gray-700"
                                        >
                            ...
                            <div className="mt-6 text-center">
                                {isAuthenticated ? (
                                    <button
                                        ...
                                        className="px-6 py-2 bg-blue-900 font-semibold text-white rounded duration-500 hover:bg-blue-700"
                                    >
                                        Add a comment
                                    </button>
                                ) : (
